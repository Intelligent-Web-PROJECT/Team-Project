...
const {searchUser} = require("../models/mongodb")
const {SEVEN_DAYS_S} = require("../util/time")
...
const passportSerializeUser = (user, callback) => {
    process.nextTick(function () {
        ...
        callback(null, {id: user.id, username: user.username, email: user.email, verified: user.email_verified});
    });
}
